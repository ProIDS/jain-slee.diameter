...
public class DiameterAvpImpl implements DiameterAvp, Externalizable {
    ...
    public static final String AVP_UNDEFINED_NAME = "undefined";

    protected long vendorId;
    protected int code, mnd = FLAG_RULE_MUST, prt = FLAG_RULE_MAY;
    protected String name = AVP_UNDEFINED_NAME;
    ...
    public DiameterAvpImpl(int code, long vendorId, int mnd, int prt, byte[] value, DiameterAvpType type) {
        this(code, vendorId, null, mnd, prt, value, type);
    }

    public DiameterAvpImpl(int code, long vendorId, String name, int mnd, int prt, byte[] value, DiameterAvpType type) {
        this.code = code;
