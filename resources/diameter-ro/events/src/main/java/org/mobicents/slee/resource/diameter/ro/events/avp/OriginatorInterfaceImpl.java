 ...
 */
public class OriginatorInterfaceImpl extends GroupedAvpImpl implements OriginatorInterface {
   ...
   * @param value
   */
  public OriginatorInterfaceImpl(int code, long vendorId, int mnd, int prt, byte[] value ) {
