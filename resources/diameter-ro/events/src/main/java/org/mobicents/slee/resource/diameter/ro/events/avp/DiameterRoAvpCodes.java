...
public class DiameterRoAvpCodes
{
  ...
  public static final DiameterAvpType APPLICATION_SERVER_AVP_TYPE = DiameterAvpType.fromString("UTF8String");
    ...
    public static final DiameterAvpType APPLICATION_SERVER_ID_AVP_TYPE = DiameterAvpType.fromString("Unsigned32");
  ...
  public static final DiameterAvpType APPLICATION_SERVER_INFORMATION_AVP_TYPE = DiameterAvpType.fromString("Grouped");
    ...
    public static final DiameterAvpType APPLICATION_SERVICE_TYPE_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
    public static final int APPLICATION_SESSION_ID = 2103;
    public static final DiameterAvpType APPLICATION_SESSION_ID_AVP_TYPE = DiameterAvpType.fromString("Unsigned32");
  ...
  public static final DiameterAvpType CLASS_IDENTIFIER_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
    ...
    public static final DiameterAvpType CLIENT_ADDRESS_AVP_TYPE = DiameterAvpType.fromString("Address");
  ...
  public static final DiameterAvpType CONTENT_TYPE_AVP_TYPE = DiameterAvpType.fromString("UTF8String");
    ...
    public static final DiameterAvpType DATA_CODING_SCHEME_AVP_TYPE = DiameterAvpType.fromString("Integer32");
  ...
  public static final DiameterAvpType DELIVERY_REPORT_REQUESTED_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
    ...
    public static final DiameterAvpType DELIVERY_STATUS_AVP_TYPE = DiameterAvpType.fromString("UTF8String");
    public static final int DESTINATION_INTERFACE = 2002;
    public static final DiameterAvpType DESTINATION_INTERFACE_AVP_TYPE = DiameterAvpType.fromString("Grouped");
  ...
  public static final DiameterAvpType INTER_OPERATOR_IDENTIFIER_AVP_TYPE = DiameterAvpType.fromString("Grouped");
    ...
    public static final DiameterAvpType INTERFACE_ID_AVP_TYPE = DiameterAvpType.fromString("UTF8String");
    public static final int INTERFACE_PORT = 2004;
    public static final DiameterAvpType INTERFACE_PORT_AVP_TYPE = DiameterAvpType.fromString("UTF8String");
    public static final int INTERFACE_TEXT = 2005;
    public static final DiameterAvpType INTERFACE_TEXT_AVP_TYPE = DiameterAvpType.fromString("UTF8String");
    public static final int INTERFACE_TYPE = 2006;
    public static final DiameterAvpType INTERFACE_TYPE_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
  ...
  public static final DiameterAvpType NODE_FUNCTIONALITY_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
    ...
    public static final DiameterAvpType NUMBER_OF_MESSAGES_SENT_AVP_TYPE = DiameterAvpType.fromString("Unsigned32");
  ...
  public static final DiameterAvpType ORIGINATOR_ADDRESS_AVP_TYPE = DiameterAvpType.fromString("Grouped");
    ...
    public static final DiameterAvpType ORIGINATOR_INTERFACE_AVP_TYPE = DiameterAvpType.fromString("Grouped");
    public static final int ORIGINATOR_RECEIVED_ADDRESS = 2027;
    public static final DiameterAvpType ORIGINATOR_RECEIVED_ADDRESS_AVP_TYPE = DiameterAvpType.fromString("Grouped");
    public static final int ORIGINATOR_SCCP_ADDRESS = 2008;
    public static final DiameterAvpType ORIGINATOR_SCCP_ADDRESS_AVP_TYPE = DiameterAvpType.fromString("Address");
  ...
  public static final DiameterAvpType PRIORITY_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
    ...
    public static final DiameterAvpType SM_PROTOCOL_ID_AVP_TYPE = DiameterAvpType.fromString("OctetString");
  ...
  public static final DiameterAvpType RECIPIENT_INFO_AVP_TYPE = DiameterAvpType.fromString("Grouped");
  ...
  public static final DiameterAvpType REPLY_APPLIC_ID_AVP_TYPE = DiameterAvpType.fromString("UTF8String");
    ...
    public static final DiameterAvpType REPLY_PATH_REQUESTED_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
  ...
  public static final DiameterAvpType SERVER_NAME_AVP_TYPE = DiameterAvpType.fromString("OctetString");
    ...
    public static final DiameterAvpType SERVICE_GENERIC_INFORMATION_AVP_TYPE = DiameterAvpType.fromString("Grouped");
  ...
  public static final DiameterAvpType SIP_RESPONSE_TIMESTAMP_AVP_TYPE = DiameterAvpType.fromString("Time");
    ...
    public static final DiameterAvpType SM_MESSAGE_TYPE_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
    public static final int SM_DISCHARGE_TIME = 2012;
    public static final DiameterAvpType SM_DISCHARGE_TIME_AVP_TYPE = DiameterAvpType.fromString("Time");
    public static final int SM_SERVICE_TYPE = 2029;
    public static final DiameterAvpType SM_SERVICE_TYPE_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
    public static final int SM_STATUS = 2014;
    public static final DiameterAvpType SM_STATUS_AVP_TYPE = DiameterAvpType.fromString("OctetString");
    public static final int SM_USER_DATA_HEADER = 2015;
    public static final DiameterAvpType SM_USER_DATA_HEADER_AVP_TYPE = DiameterAvpType.fromString("OctetString");
    public static final int SMS_INFORMATION = 2000;
    public static final DiameterAvpType SMS_INFORMATION_AVP_TYPE = DiameterAvpType.fromString("Grouped");
    public static final int SMS_NODE = 2016;
    public static final DiameterAvpType SMS_NODE_AVP_TYPE = DiameterAvpType.fromString("Enumerated");
    public static final int SMSC_ADDRESS = 2017;
    public static final DiameterAvpType SMSC_ADDRESS_AVP_TYPE = DiameterAvpType.fromString("Address");
