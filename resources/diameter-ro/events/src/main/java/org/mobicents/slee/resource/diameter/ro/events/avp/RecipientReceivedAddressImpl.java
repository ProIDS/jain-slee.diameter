...
/**
 * Implementation of the Recipient-Received-Address grouped AVP type.<br>
 * <br>
 *
 * @author <a href="mailto:grzegorz.figiel@pro-ids.com"> Grzegorz Figiel [ProIDS] </a>
 */
public class RecipientReceivedAddressImpl extends GroupedAvpImpl implements RecipientReceivedAddress {
   ...
   * @param value
   */
  public RecipientReceivedAddressImpl(int code, long vendorId, int mnd, int prt, byte[] value ) {
